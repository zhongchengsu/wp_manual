...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'manual' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'manual' ),
		'repeat-y'  => __( 'Repeat Vertically', 'manual' ),
		'repeat'    => __( 'Repeat All', 'manual' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'manual' ),
		'top center'    => __( 'Top Center', 'manual' ),
		'top right'     => __( 'Top Right', 'manual' ),
		'center left'   => __( 'Middle Left', 'manual' ),
		'center center' => __( 'Middle Center', 'manual' ),
		'center right'  => __( 'Middle Right', 'manual' ),
		'bottom left'   => __( 'Bottom Left', 'manual' ),
		'bottom center' => __( 'Bottom Center', 'manual' ),
		'bottom right'  => __( 'Bottom Right', 'manual')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'manual' ),
		'fixed'  => __( 'Fixed in Place', 'manual')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'manual' ),
		'italic'      => __( 'Italic', 'manual' ),
		'bold'        => __( 'Bold', 'manual' ),
		'bold italic' => __( 'Bold Italic', 'manual' )
		);
